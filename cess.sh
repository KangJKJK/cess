...
echo -e "${YELLOW}엔터${NC}"
echo -e "${BLUE}3. Enter cess rpc ws-url${NC}"
echo -e "${YELLOW}엔터${NC}"
echo -e "${BLUE}4. Enter cess storage earnings account${NC}"
echo -e "${YELLOW}리워드를 받을 지갑 주소${NC}"
echo -e "${BLUE}5. Enter cess storage signature account phrase${NC}"
echo -e "${YELLOW}위와 다른 지갑의 복구문자${NC}"
echo -e "${BLUE}6. Enter cess storage disk path${NC}"
echo -e "${YELLOW}엔터${NC}"
echo -e "${BLUE}7. Enter cess storage space, by GB unit${NC}"
echo -e "${YELLOW}100${NC}"
echo -e "${BLUE}8. Enter the number of CPU cores used for mining${NC}"
echo -e "${YELLOW}Your CPU cores라고 나오는 숫자${NC}"
echo -e "${BLUE}9. Enter the staking account if you use one account to stake multiple nodes${NC}"
echo -e "${YELLOW}엔터${NC}"
echo -e "${BLUE}10. Enter the TEE worker endpoints if you have any${NC}"
echo -e "${YELLOW}엔터${NC}"
